/* Curious Kids Club visit counter. Same Supabase table as The Gentle Bookshop (book = 'curious-club').
...
(function () {
  ...
  try {
    ...
    if (src) { try { sessionStorage.setItem('cc_src', src); } catch (e) {} }
    else { try { src = sessionStorage.getItem('cc_src'); } catch (e) {} }
